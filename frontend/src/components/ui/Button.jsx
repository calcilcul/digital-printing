...
import { cn } from './Skeleton'; // we'll use the same cn helper
...
export function Button({ 
  ...
  const variants = {
    ...
    secondary: "bg-secondary-500 hover:bg-secondary-600 text-white shadow-sm focus:ring-secondary-400",
    outline: "border-2 border-slate-200 hover:border-slate-300 text-slate-700 bg-transparent focus:ring-slate-200",
